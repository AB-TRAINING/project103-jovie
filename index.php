...
<head>
  ...
  <link href="css/jovie-opl.webflow.css?ver=1.1" rel="stylesheet" type="text/css">
...
<body class="body">
  <div class="columns w-row">
    ...
    <div class="rightcontent w-col w-col-6 w-col-stack">
      <div data-w-id="3fd5aeb3-22da-ed60-7286-0d11f16597d3" style="opacity:0" class="content"></div>
        <h1 class="tagline"><strong class="bold-text">JOVIE NIEL BALTAZAR</strong></h1>
        <hr>
        <p class="bio">Currently studying to be a Web Developer, teach me senpai. </p>
        <p class="bio">Thank you for visiting my webpage. </p>
        <div class="links w-row">
          <div class="column-2 w-col w-col-4">
            <div class="text-block-2">social</div>
            <ul role="list" class="list w-list-unstyled">
              <li>
                <a href="https://web.facebook.com/jovieniel.baltazar/" target="_blank">Facebook</a>
              </li>
              <li>
                <a href="https://github.com/mynameis-jojo" target="_blank">Github</a>
              </li>
            </ul>
          </div>
